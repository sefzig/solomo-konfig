...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			...
			de_de: 'Installiere diese Seite auf dem %device: %icon antippen und <strong>Zum Home-Bildschirm</strong>.',
	...
	function loaded () {
		...
		balloon.style.cssText += 'position: fixed; left:-9999px;-webkit-transition-property:-webkit-transform,opacity;-webkit-transition-duration:0;-webkit-transform:translate3d(0,0,0);position:' + (OSVersion < 5 ? 'absolute' : 'fixed');
     ...
     // document.body.appendChild(balloon);
        document.getElementById('wrapper').appendChild(balloon);
